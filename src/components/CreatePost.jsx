...
export default function CreatePost() {
  ...
  const [main_tex_file, setMainTex] = useState("");
  ...
  const upload = async () => {
    ...
    formdata.append("main_tex_file", main_tex_file);
    formdata.append("pdf_name", pdfName);
    formdata.append("pdf_description", description);
        ...
        <form className={classes.form} noValidate>
          ...
          <div className={classes.formRow}>
            <TextField
              ...
              required
              id="main_tex"
              placeholder="main tex file name. Ex: main.tex"
              autoFocus
              onChange={(event) => {
                setMainTex(event.target.value);
              }}
